package com.example.examplemod.clickgui.component;
...
import com.example.examplemod.clickgui.component.components.Button;
...
public class Frame {
	...
	public Frame(Category cat) {
		...
		for(Module mod : ExampleMod.instance.moduleManager.getModulesInCategory(category)) {
	...
	public void renderFrame(FontRenderer fontRenderer) {
		...
		fontRenderer.drawStringWithShadow(this.category.name(), (this.x + 2) * 2 + 5, (this.y + 2.5f) * 2 + 5, 0xFFFFFFFF); //Module Text Color (Color of combat,misc etc)
